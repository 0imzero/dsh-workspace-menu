window.__ModuleLoader__.load({
  ...
  `;
		...
		function SettingsItem() {
			...
			const header = { padding: "14px 16px 6px" };
			const title = {
				margin: 0,
				fontSize: 14,
				fontWeight: 600,
			...
			return (0, react.createElement)("div", { style: container }, (0, react.createElement)("div", { style: header }, (0, react.createElement)("p", { style: title }, "工作区菜单"), (0, react.createElement)("p", { style: desc }, "开关工作区/会话右键与双击菜单里的各项功能。")), FEATURE_GROUPS.map((group) => (0, react.createElement)("div", { key: group.title }, (0, react.createElement)("div", { style: groupTitle }, group.title), group.keys.map((key) => (0, react.createElement)("div", {
				key,
				style: row
