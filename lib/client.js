window.__ModuleLoader__.load({
  ...
  `;
		...
		function Switch({ checked, onChange, label }) {
			...
			}), (0, react.createElement)("span", { style: track }, (0, react.createElement)("span", { style: thumb })));
		}
		function SettingsItem() {
			...
			return (0, react.createElement)("div", { style: container }, (0, react.createElement)("button", {
				type: "button",
				style: header,
				"aria-expanded": open,
				onClick: () => {
			...
			}, (0, react.createElement)("span", { style: headText }, (0, react.createElement)("span", { style: title }, "工作区菜单"), (0, react.createElement)("span", { style: desc }, "开关工作区/会话右键与双击菜单里的各项功能。")), (0, react.createElement)("span", { style: chevron }, (0, react.createElement)(_deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutline14, { size: 14 }))), open && (0, react.createElement)("div", { style: body }, FEATURE_GROUPS.map((group) => (0, react.createElement)("div", { key: group.title }, (0, react.createElement)("div", { style: groupTitle }, group.title), group.keys.map((key) => (0, react.createElement)("div", {
				key,
				style: toggleRow
			}, (0, react.createElement)("span", null, FEATURE_LABELS[key]), (0, react.createElement)(Switch, {
